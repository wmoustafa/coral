 ...
 */
package com.linkedin.coral.benchmark.trino.dialect;
 ...
 */
public final class TrinoDialectPluginProvider implements DialectPluginProvider {
  ...
  public DialectPlugin create(CoralCatalog catalog) {
    return new TrinoDialectPlugin(catalog);
  }
}
