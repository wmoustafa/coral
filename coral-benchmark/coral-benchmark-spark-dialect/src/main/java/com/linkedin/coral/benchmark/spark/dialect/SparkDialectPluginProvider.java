 ...
 */
package com.linkedin.coral.benchmark.spark.dialect;
 ...
 */
public final class SparkDialectPluginProvider implements DialectPluginProvider {
  ...
  public DialectPlugin create(CoralCatalog catalog) {
    return new SparkDialectPlugin(catalog);
  }
}
